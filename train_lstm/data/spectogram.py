...
#MODEL
# Load the WAV audio file
sampling_rate, audio_data = wavfile.read(r'C:\Users\Utente\OneDrive - Politecnico di Milano\Immagini\Documenti\Development\Python\PROJECT-STMAE\PROJECT-STMAE-2023\train_lstm\data\archive\test\test_model\0.3-0.3-0.3.wav')
# Calculate the spectrogram
frequencies, times, Sxx = spectrogram(audio_data, fs=sampling_rate)
...
plt.colorbar(label='Intensity (dB)')
plt.ylim(0, 5000)  # Limit the displayed frequencies in the plot
plt.savefig(r'C:\Users\Utente\OneDrive - Politecnico di Milano\Immagini\Documenti\Development\Python\PROJECT-STMAE\PROJECT-STMAE-2023\train_lstm\data\plot\plot_model\spectrogram_0.3-0.3-0.3.jpg')
plt.show()
